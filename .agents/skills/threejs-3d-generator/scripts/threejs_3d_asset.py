...
def download_url(url: str, out_dir: Path, filename_base: str, key: str) -> Path:
    # Tripo's signed CDN is fronted by a WAF that rejects urllib's default
    # Python user-agent with Cloudflare 1010. A browser-like header keeps the
    # download path reliable without exposing the signed URL to the client.
    req = request.Request(
        url,
        method="GET",
